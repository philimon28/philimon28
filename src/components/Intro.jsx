    ...
    <>
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          <h1 className='md:text-6xl text-2xl sm:text-2xl font-extrabold mb-4 text-black '>we can help you <span className='text-black'>Find right Job .</span> </h1>
          <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>400 Peoples are daily search in this portal, 20 users added BloomsExpert!</p>
          <div className='bg-white flex-col mb-6 w-full md:px-4   py-4 flex sm:flex-row items-center justify-center'>
            ...
            <input onChange={(e) => setSearch(e.target.value)} type="text" placeholder='Search Jobs with categories like Software Developer ...' className='xs:w-full w-3/4  h-full px-2 bg-gray-200 text-base py-3 outline-none' />
          ...
          <div className=' w-full px-2 py-2 flex items-center justify-start flex-wrap'>
            ...
            <div className='flex   items-center justify-center px-3 flex-wrap'>
              <p className='px-2  text-gray-600'>Software development</p>
              <p className='px-2  text-gray-600'>Digital Marketing</p>
              <p className='px-2  text-gray-600'>Engineering Design</p>
        ...
        <div className='w-3/6 my-2 h-full bg-gray-200 hidden items-center justify-center flex-col p-20 lg:flex'>
          <Image className="inline-block h-900 w-800 rounded-full ring-2 ring-white" width={800} height={900} src="/display.png" alt="no-image-found" />
        </div>
      </div>
      {
        doneSearch && (
